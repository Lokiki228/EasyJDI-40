...
- отчет об успешности настройки(ТОЛЬКО в режиме настройки через АТ): отправили команду - получаем данные с UART - и понимаем 
- проверка наличия модуля
### В будующем
- наследование класса print
- получение всех настроек с модуля
- возможно что-нибудь придумаю со скоростью настроек, но времени у меня мало.
## Совместимость
С ней проблем не должно быть, т.к. используются ардуино функции.
Но для справки! Я тестировал это на esp8266 и lgt8f328.
## Скорость
Т.к. UART довольно медленный, при 9600 бод, настройки выполняются со скоростью около 500мс, кароче долго. 
## Методы
### Конструктор
